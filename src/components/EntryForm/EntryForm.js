...
export default class EntryForm extends Component {
  ...
  render() {
    ...
    <form id="record-mood">
        ...
        <input type="text" name="title" placeholder="Feeling weird" required />
        </div>
        <div className="form-section">
        <label htmlFor="mood-content">Why am I feeling this way?</label>
        <textarea name="content" rows="15" columns="30" placeholder="Type your entry..." required></textarea>
        </div>
        <div className="time-mood-container" className="form-section">
        <label htmlFor="time-mood">How long did the mood last?</label>
        <input type="number" name="duration" placeholder="8" />
        </div>
        <div className="form-section">
        <p>Select mood range</p>

        <input type="radio" name="mood_type" value="Balanced" className="mood-type-radio" checked />
        ...
        <input type="radio" name="mood_type" value="Low" className="mood-type-radio" />
        <label htmlFor="mood-type">
            <span>Low</span>
        ...
        <input type="radio" name="mood_type" value="Extreme" className="mood-type-radio" />
        <label htmlFor="mood-type">
            <span>Extreme</span>
        ...
        <input type="radio" name="mood_type" value="Erratic" className="mood-type-radio" />
        <label htmlFor="mood-type">
            <span>Erratic</span>
        ...
        <input type="radio" name="mood_type" value="Unsure" className="mood-type-radio" />
        <label htmlFor="mood-type">
            <span>Unsure</span>
